...
| ----------------- | ------------------------- | ------------------------------------- | -------------------------------------------------------------------------- |
| upload            | Single file upload        | key, mimeType                         | `https://api.apexxcloud.com/upload?x-signature=...`                        |
| start-multipart   | Start multipart upload    | key, totalParts, mimeType             | `https://api.apexxcloud.com/multipart/start?x-signature=...`               |
| uploadpart        | Upload individual part    | uploadId, partNumber, key, totalParts | `https://api.apexxcloud.com/multipart/{uploadId}/upload?x-signature=...`   |
| completemultipart | Complete multipart upload | uploadId, key                         | `https://api.apexxcloud.com/multipart/{uploadId}/complete?x-signature=...` |

...
| Crop           | `crop(mode)`                  | 'fill', 'fit', 'scale', etc.                       | `.crop('fill')`                  |
| Quality        | `quality(value)`              | 1-100 or 'auto:best/good/eco/low'                  | `.quality('auto:good')`          |
| Format         | `format(type)`                | 'auto', 'webp', 'jpeg', 'png', 'avif'              | `.format('webp')`                |
| Blur           | `blur(radius)`                | 1-100                                              | `.blur(20)`                      |
| Grayscale      | `grayscale()`                 | -                                                  | `.grayscale()`                   |
| Background     | `background(color)`           | hex color or 'transparent'                         | `.background('#ff0000')`         |
| Border         | `border(width, style, color)` | width(px), style, hex color                        | `.border(2, 'solid', '#000000')` |
| Radius         | `radius(value)`               | px or [topLeft, topRight, bottomRight, bottomLeft] | `.radius(10)`                    |
...
| Format         | `format(type)`          | 'mp4', 'webm', 'mov', 'auto' | `.format('mp4')`      |
| Thumbnail      | `thumbnail(seekOffset)` | Time in seconds              | `.thumbnail(5.0)`     |
| Crop           | `crop(mode)`            | 'crop', 'fill', 'fit', etc.  | `.crop('fill')`       |
| Background     | `background(color)`     | hex color or 'blur'          | `.background('blur')` |
